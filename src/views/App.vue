            ...
            <template>
               <div class="main">
                  <el-input
                    type="textarea"
                    :autosize="{ minRows: 5}"
                    placeholder="Please input an English sentence to test!"
                    style="width:80%;"
                    v-model="text">
            	  </el-input>
            	  ...
            	  <el-input
                    type="textarea"
                    :autosize="{ minRows: 5}"
                    placeholder="Please input a Chinese sentence to test!"
                    style="width:80%;"
                    v-model="text2">
            	  </el-input>
            	  <el-button type="primary" @click="handleProcessZh">Analyse</el-button>
               </div>
...
<script>
import {nlp, nlp_zh} from './index.js'
